...
select cron.schedule('faturai_analytics_nightly', '0 3 * * *', 'select public.fn_refresh_analytics();')
where not exists (select 1 from cron.job where jobname = 'faturai_analytics_nightly');